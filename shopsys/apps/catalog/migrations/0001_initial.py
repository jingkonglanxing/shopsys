# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-10 10:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_keywords', models.CharField(help_text='meta描述', max_length=255, verbose_name='Meta 描述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='根据name生成的, 用于生成URL, 必须唯一', max_length=255, unique=True, verbose_name='Slug')),
                ...
                ('old_price', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=9, verbose_name='就价格')),
                ...
                ('description', models.TextField(verbose_name='描述')),
                ('meta_keywords', models.CharField(help_text='Meta 描述标签', max_length=255, verbose_name='Meta描述')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
